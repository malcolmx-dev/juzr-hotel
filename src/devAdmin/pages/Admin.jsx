...
export default function DevAdmin(){
    ...
    const [hotels, setHotel] = useState(false)
        ...
        <div>
            ...
            <div className="bg-secondary d-flex h-100 border">
                <Nav defaultActiveKey="/home" className=" border flex-column ps-2 pe-2 h-100">
                    ...
                    <Nav.Link onClick={()=>{setDasboard(true); setUser(false); setHotel(false); setBlackList(false); setReservation(false)}} className="text-light fs-5 border-bottom pb-4"><AiFillDashboard className="mb-1 " /> Dashboard</Nav.Link>
